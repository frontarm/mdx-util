...
metaDescription: "Learn how to configure your Markdown with custom React Components instead of standard HTML elements"
---
...
The [armo-breadboard](https://github.com/jamesknelson/armo-breadboard/blob/3ee04661299a7b663da7ff352f495069c36cc169/source/MDXBreadboard.js#L103) package uses a `codeBlock` factory to provide live examples for code blocks fenced with the `mdx` language.
...
The MDXC website website uses `armo-breadboard`, so you can use it test out MDX!
